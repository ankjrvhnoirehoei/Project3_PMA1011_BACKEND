...
const Phone = new Schema({                  // Note: all ID are to be defined as Long in java, as taken by the milliseconds of created date
    ...
    phoneSold: {type: Number, default: 0},              // phones that have been accepted and paid for
    ...
    phoneInStore: {type: Number, default: 1},           // Boolean check if the phone is still available in store for sale
});
